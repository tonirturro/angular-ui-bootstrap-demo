describe('uib-accordion', function() {
  ...
  beforeEach(angular.mock.module('ui.bootstrap.accordion'));
  beforeEach(angular.mock.module('ngAnimateMock'));
  beforeEach(angular.mock.module('uib/template/accordion/accordion.html'));
  beforeEach(angular.mock.module('uib/template/accordion/accordion-group.html'));
  ...
  describe('uib-accordion-group', function() {
    ...
    describe('is-open attribute with dynamic content', function() {
      ...
      it('should have visible panel body when the group with isOpen set to true', function() {
        expect(findGroupBody(0).get(0)).toHaveClass('in');
        expect(findGroupBody(1).get(0)).not.toHaveClass('in');
      });
    });
    ...
    describe('is-open attribute with custom class', function() {
      ...
      it('should add "panel-open" class', function(){
        expect(groups.get(0)).not.toHaveClass('panel-open');
        expect(groups.get(1)).toHaveClass('panel-open');
      });
    });
    ...
    describe('`is-disabled` attribute', function() {
      ...
      it('should have text-muted styling', function() {
        expect(findGroupLink(0).find('span:first').get(0)).toHaveClass('text-muted');
      });
    });
