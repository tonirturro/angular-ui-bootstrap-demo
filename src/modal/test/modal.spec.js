describe('$uibResolve', function() {
  ...
  describe('with custom resolver', function() {
    beforeEach(angular.mock.module(function($provide, $uibResolveProvider) {
...
describe('$uibModal', function() {
  ...
  beforeEach(angular.mock.module('ui.bootstrap.modal'));
  beforeEach(angular.mock.module('uib/template/modal/window.html'));
  beforeEach(angular.mock.module(function(_$controllerProvider_, _$uibModalProvider_, $compileProvider) {
  ...
  describe('basic scenarios with default options', function() {
    ...
    xit('should not focus on the element that has autofocus attribute when the modal is opened and something in the modal already has focus and the animations have finished', function() {
      function openAndCloseModalWithAutofocusElement() {
        ...
        expect(angular.element('#pre-focus-element').get(0)).toHaveFocus();
  ...
  describe('option by option', function() {
    ...
    describe('backdrop', function() {
      ...
      it('should contain backdrop in classes on each modal opening', function() {
        ...
        var backdropEl = $document.find('body > div.modal-backdrop').get(0);
        expect(backdropEl).toHaveClass('in');

        dismiss(modal);

        modal = open({ template: '<div>With backdrop</div>' });
        backdropEl = $document.find('body > div.modal-backdrop').get(0);
        expect(backdropEl).toHaveClass('in');
      ...
      describe('custom backdrop classes', function () {
        it('should support additional backdrop class as string', function() {
          ...
          expect($document.find('div.modal-backdrop').get(0)).toHaveClass('additional');
        });
      });
    });
    ...
    describe('custom window classes', function() {
      it('should support additional window class as string', function() {
        ...
        expect($document.find('div.modal').get(0)).toHaveClass('additional');
      });
    });
    ...
    describe('top window class', function () {
      it('should support top class option', function () {
        ...
        expect($document.find('div.modal').get(0)).toHaveClass('top-class');
      });
    });
    ...
    describe('size', function() {
      it('should support creating small modal dialogs', function() {
        ...
        expect($document.find('div.modal-dialog').get(0)).toHaveClass('modal-sm');
      });
      ...
      it('should support creating large modal dialogs', function() {
        ...
        expect($document.find('div.modal-dialog').get(0)).toHaveClass('modal-lg');
      });
      ...
      it('should support custom size modal dialogs', function() {
        ...
        expect($document.find('div.modal-dialog').get(0)).toHaveClass('modal-custom');
      });
    });
    ...
    describe('animation', function() {
      it('should have animation fade classes by default', function() {
        ...
        expect($document.find('.modal').get(0)).toHaveClass('fade');
        expect($document.find('.modal-backdrop').get(0)).toHaveClass('fade');
      });
      ...
      it('should not have fade classes if animation false', function() {
        ...
        expect($document.find('.modal').get(0)).not.toHaveClass('fade');
        expect($document.find('.modal-backdrop').get(0)).not.toHaveClass('fade');
      });
    });
  ...
  describe('modal window', function() {
    ...
    it('should support window top class', function () {
      $rootScope.animate = false;
      var windowEl = $compile('<div uib-modal-window animate="animate" window-top-class="test foo">content</div>')($rootScope).get(0);
      $rootScope.$digest();
  ...
  describe('multiple modals', function() {
    ...
    it('should have top class only on top window', function () {
      ...
      expect($document.find('div.modal1').get(0)).toHaveClass('modal-top');
      expect($document).toHaveModalsOpen(1);

      var modal2 = open({template: '<div>Content1</div>', windowClass: 'modal2', windowTopClass: 'modal-top'});
      expect($document.find('div.modal1').get(0)).not.toHaveClass('modal-top');
      expect($document.find('div.modal2').get(0)).toHaveClass('modal-top');
      expect($document).toHaveModalsOpen(2);

      var modal3 = open({template: '<div>Content1</div>', windowClass: 'modal3', windowTopClass: 'modal-top'});
      expect($document.find('div.modal1').get(0)).not.toHaveClass('modal-top');
      expect($document.find('div.modal2').get(0)).not.toHaveClass('modal-top');
      expect($document.find('div.modal3').get(0)).toHaveClass('modal-top');
